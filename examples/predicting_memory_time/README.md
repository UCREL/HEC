# Estimating and understanding the required amount of memory and compute time
...
From the example in section [Tagging data as the example use case](#tagging-data-as-the-example-use-case) and the main point of this README is to provide you with the tools and knowledge of understanding where the main cause of increasing memory and time is likely to come from:
